...
import EditPreviewInvoiceItem from "./EditPreviewInvoiceItem";
            ...
            >
              <FormGroup className="mb-0">
                <InputGroup className="input-group-alternative">
                  ...
                  <Input
                    placeholder="Search by Invoice No. and press enter"
                    type="search"
                    value={invoiceQuery}
                    onChange={(e) => {
                    ...
                    style={{ minWidth: 350 }}
                  />
                  {/* <InputGroupAddon addonType="append" hidden>
                    <InputGroupText>
                      <button
                        aria-label="Close"
                        className="close"
        ...
        >
          ...
          <div style={styles.footer}>
            <div style={styles.total}>
              ...
              <h5>
                Total Amount to Refund ({searchResults?.currency}):&nbsp;&nbsp;
                {moneyInTxt(amountToRefund)}
                {/* {moneyInTxt(searchResults.totalAmount)} */}
                {/* {moneyInTxt(
